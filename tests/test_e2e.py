...
from design_converter.utils.jsx_parser import parse_jsx, reset_id_counter
...
class TestJSXToUNNodePipeline:
    ...
    def test_component_extraction_to_unnode(self):
        ...
        from design_converter.utils.jsx_parser import parse_jsx_component
...
class TestMockPaperClientPipeline:
    ...
    @patch("design_converter.adapters.paper.client._post")
    def test_mock_paper_to_figma(self, mock_post):
        ...
        from design_converter.adapters.paper.client import PaperClient
