...
from design_converter.adapters.paper.client import (
    PaperClient,
...
class TestPostFunction:
    ...
    @patch("design_converter.adapters.paper.client.urlopen")
...
class TestPaperClientSSEMode:
    ...
    @patch("design_converter.adapters.paper.client._SSESession")
