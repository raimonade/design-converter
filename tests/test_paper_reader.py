...
from design_converter.utils.jsx_parser import (
    parse_jsx,
    parse_jsx_component,
...
from design_converter.utils.css import apply_css_to_node, merge_styles, parse_inline_style
...
class TestUNNodeSerialization:
    ...
    def test_text_node_roundtrip(self):
        ...
        from design_converter.ir import UNTextStyle, TextAlign, TextAutoResize
    ...
    def test_fills_and_strokes_roundtrip(self):
        ...
        from design_converter.ir import UNStroke, UNStrokeThickness
...
class TestApplyCSSToNode:
    ...
    def test_apply_border_radius(self):
        ...
        from design_converter.ir import UNCornerRadius
