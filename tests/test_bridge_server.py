"""
Unit tests for Figma Bridge Server (design_converter/adapters/figma/bridge_server.py).
...
class TestBridgeServerConfig:
    ...
    def test_default_port(self):
        ...
        from design_converter.adapters.figma.bridge_server import DEFAULT_PORT
        assert DEFAULT_PORT == 9223

    def test_fallback_ports_range(self):
        """Fallback ports are 9224-9232."""
        from design_converter.adapters.figma.bridge_server import FALLBACK_PORTS
        assert FALLBACK_PORTS == [9224, 9225, 9226, 9227, 9228, 9229, 9230, 9231, 9232]

    def test_retry_config(self):
        """Phase 5: Retry configuration is set."""
        from design_converter.adapters.figma.bridge_server import MAX_RETRIES, RETRY_BACKOFF_BASE, RETRY_BACKOFF_MULTIPLIER
    ...
    def test_batch_config(self):
        ...
        from design_converter.adapters.figma.bridge_server import BATCH_MAX_OPERATIONS, FONT_PRECACHE_TIMEOUT_MS
...
class TestWebSocketFrame:
    ...
    def test_make_ws_frame_text(self):
        ...
        from design_converter.adapters.figma.bridge_server import make_ws_frame
    ...
    def test_make_ws_accept_key(self):
        ...
        from design_converter.adapters.figma.bridge_server import make_ws_accept_key
    ...
    def test_parse_ws_frame_simple(self):
        ...
        from design_converter.adapters.figma.bridge_server import parse_ws_frame, make_ws_frame
...
class TestBridgeServer:
    ...
    def test_init_default_port(self):
        ...
        from design_converter.adapters.figma.bridge_server import FigmaBridgeServer
...
class TestPortDiscovery:
    ...
    def test_write_port_file_content(self):
        ...
        from design_converter.adapters.figma.bridge_server import write_port_file, remove_port_file
        import os
    ...
    def test_remove_port_file_safe(self):
        ...
        from design_converter.adapters.figma.bridge_server import remove_port_file
...
class TestPendingRequest:
    ...
    def test_pending_request_fields(self):
        ...
        from design_converter.adapters.figma.bridge_server import PendingRequest
...
class TestBatchOperations:
    ...
    def test_batch_too_many_operations_returns_400(self):
        ...
        from design_converter.adapters.figma.bridge_server import FigmaBridgeServer, BATCH_MAX_OPERATIONS
...
class TestRetryLogic:
    ...
    def test_retry_config_values(self):
        ...
        from design_converter.adapters.figma.bridge_server import (
            MAX_RETRIES,
            RETRY_BACKOFF_BASE,
