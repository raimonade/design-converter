...
=======================
Tool adapters implement these two classes.
...
class BaseReader(ABC):
    ...
    tool_name: str = "base"  # Override in subclass, e.g. "paper" or "figma".
...
# ---------------------------------------------------------------------------
# Registry  (optional — lets an orchestrator look up adapters by name)
# ---------------------------------------------------------------------------
