...
Usage:
    from design_converter.utils.tokens import extract_tokens, export_tokens_json
...
def _collect_typography(root: Any) -> Dict[str, Any]:
    ...
    """
    from design_converter.ir import NodeType
...
def _collect_shadows(root: Any) -> Dict[str, Any]:
    ...
    """
    from design_converter.ir import UNDropShadow
    seen: set = set()
    tokens: Dict[str, Any] = {}
